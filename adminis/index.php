...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header tab" style="padding: 0px !important;background: #8cfffb!important">
                <button style="color: #000;" class="tablinks active" onclick="openTab(event, 'Upcoming')">
                    Reservas Próximas
                </button>
                <button style="color: #000;" class="tablinks" onclick="openTab(event, 'All')">
                    Todas las Reservas
                </button>
                <button style="color: #000;" class="tablinks" onclick="openTab(event, 'Canceled')">
                    Reservas Canceladas
                </button>
            </div>
            <div class="card-body">
