...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<!-- Sidebar -->
		<ul style="background-color: #8cfffb; background-image: linear-gradient(180deg, aqua 10%,#8cfffb 100%);" class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">

			<!-- Sidebar - Brand -->
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
				<div style="color:black" class="sidebar-brand-icon rotate-n-10">
					FACETICKET
				</div>
			</a>
			...
			<!-- Heading -->
			<div style="color: #000;" class="sidebar-heading color">
			...
			<li class="nav-item">
				<a class="nav-link" href="service-categories.php">
					...
					<span style="color: #000;">Categorías de Servicios</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="services.php">
					<i class="bs bs-scissors-1"></i>
					<span style="color: #000;">Servicios</span>
				</a>
			</li>
			<!-- Divider -->
			<hr class="sidebar-divider">
			...
			<!-- Heading -->
			<div style="color: #000;" class="sidebar-heading">
				Clientes y Staff
			</div>
		...
		<!-- Content Wrapper -->
		<div style="background-color: #000;" id="content-wrapper" class="d-flex flex-column">
